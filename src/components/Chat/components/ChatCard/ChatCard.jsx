    ...
    <>
      <div className="flex items-center justify-center py-2 group cursor-pointer">
        <div className="w-[20%]">
          <img
            ...
            src="https://cdn.pixabay.com/photo/2015/01/12/10/44/woman-597173_1280.jpg"
            alt=""
          />
        </div>
        <div className="pl-5 w-[80%]">
          <div className="flex justify-between items-center">
            ...
            <p className="text-sm">timesstamp</p>
          </div>
          <div className="flex justify-between items-center">
            <p>message...</p>
      ...
      <div className="flex items-center justify-center py-2 group cursor-pointer">
        <div className="w-[20%]">
          <img
            className="h-14 w-14 rounded-full"
            src="https://cdn.pixabay.com/photo/2018/02/05/16/41/monkey-3132624_1280.jpg"
            alt=""
          />
        </div>
        <div className="pl-5 w-[80%]">
